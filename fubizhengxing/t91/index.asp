...
<meta name="keywords" content="手术计划" />
<meta name="description" content="手术计划" />
<title>手术计划</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div class="content" id="artcontent"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: medium"><b>手术计划</b></span></p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 当你第一次看医生时，整形外科医生将评估你的健康情况，腹部脂肪的堆积情况和皮肤的松弛程度。这时你一定要将你的既往病史，包括有关内科情况如有无糖尿病、高血压或心脏疾病、手术史、接受过的治疗和目前服用的药物等尽可能全面地告诉医生；要非常坦白地与医生讨论你的期望，医生也会诚实的向你交代你术后的改变，手术的风险。 例如，如果你的腹部脂肪只是堆积在脐下部，你可能只是需要做一个并不复杂的部分腹壁整形手术，这个手术可以在门诊手术室进行。另外，如果腹壁整形手术或部分腹壁整形手术再配合腹部吸脂术同时进行，在腹部的塑形方面会有更好的效果。&nbsp;</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 整形外科医生会向你说明，他们建议你应该采用的手术方式，即腹壁整形术、部分腹壁整形术或单纯的腹部吸脂术，它将最接近你所期望的腹部形态。 医生也将同时向你介绍根据你的情况，应该采用何种麻醉（全麻或局麻），在什么地方做手术（门诊手术室或住院手术室），是否需要住院和大约需要多少费用等。<br />
&nbsp;</p></div></td>
  </tr>
</table>
                  </td>
