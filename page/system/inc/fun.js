...
if (I1=='delete'){isconfirm=confirm(WO_delete);}else{isconfirm=true};
	...
	if (id=='aja'||id=='flo')
		{
			...
			{//document.body.scrollTop
				...
				doc.innerHTML='<div id="ajatitle"><span>Loading...</span><img src="'+WebOrigin_page+'system/images/close.gif" class="os" onclick="display(\'aja\')"/></div><div id="load"><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>Loading...</div>';}
			else
			{
				...
				doc.innerHTML='<div id="flotitle"><span>Loading...</span><img src="'+WebOrigin_page+'system/images/close.gif" class="os" onclick="display(\'aja\')"/></div><div id="flomain">Loading...</div>';
			}
		}
	else
		{doc.innerHTML='<img class=""os"" src="'+WebOrigin_page+'system/images/load.gif"/>';}
}
//posthtm
