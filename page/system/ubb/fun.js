function UBB(id,content,cols,rows,type,path){
	...
	document.write('<div id="WebOriginubb">');
	...
	document.write('<span><a href="javascript:;" onclick="javascript:ubb.Color();"><img src="'+path+'ubb/Color.gif"/></a><em id="WebOriginCMS_Color"></em></span>');
	document.write('<span><a href="javascript:;" onclick="javascript:ubb.Emo();"><img src="'+path+'ubb/Emo.gif"/></a><em id="WebOriginCMS_Emo"></em></span>');
	if(type){
	...
	this.Emo=function(){document.getElementById("WebOriginCMS_Emo").style.visibility=="hidden"?gethtm(path+'emo.asp','WebOriginCMS_Emo'):display('WebOriginCMS_Emo')}
	this.EmoShow=function(emo){this.addtag('em',emo);display('WebOriginCMS_Emo');}

	this.Color=function(){document.getElementById("WebOriginCMS_Color").style.visibility=="hidden"?gethtm(path+'ubb/color.htm','WebOriginCMS_Color'):display('WebOriginCMS_Color')}
	this.Chcolor=function(color){this.addtag('color',color);display("WebOriginCMS_Color");}
