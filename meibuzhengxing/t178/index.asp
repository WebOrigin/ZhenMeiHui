...
<meta name="keywords" content="眉位不正" />
<meta name="description" content="眉位不正" />
<title>眉位不正</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div class="content" id="artcontent"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: medium"><strong>眉位不正</strong></span></p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 因为外伤和老年性眉毛下垂，可使眉毛发生移位或部分缺损。老年性眉毛下垂，如果是因为前额皮肤松驰引起的，最好的办法是采取额颞部皮肤提紧术来矫正。当没有这种必要时，也可用局部切除提高法来修正。眉毛或眉周围部位受到外伤后，因颜痕挛缩会使部分眉毛发生向上或向下的移位。但不论什么样的移位，都可以采用&ldquo;Z&rdquo;成形术加以纠正。</p></div></td>
  </tr>
</table>
                  </td>
                  </tr>
