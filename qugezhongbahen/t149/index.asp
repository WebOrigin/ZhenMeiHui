...
<meta name="keywords" content="烧伤后瘢痕性秃发" />
<meta name="description" content="烧伤后瘢痕性秃发的治疗有以下几种方法：1、完全撕脱 伤口完全愈合后，如病人急于解决秃发问题，可以装配假发，这就是所谓的赝复治疗。2、皮瓣法或叫次切除法 这种方法适用于尚留有部分头发者，可以设计成条状皮瓣转移到容貌迫切需要的部位，如额前发际区两侧颞区等，待头以长出后，即可掩盖秃发部位，在秃发区不大，且周围组织较松的部位，可以分次切除瘢痕，游离周围皮下组织，直接缝合，也可完全消除秃发，但秃发面积太大就不能应用此方法。3、插秧法 有时所有的有发区域无法转移皮瓣时，则可以采用插秧的方法，在有头发的区域取一窄条带毛" />
<title>烧伤后瘢痕性秃发</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div class="content" id="artcontent"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: medium"><b>烧伤后瘢痕性秃发怎样治疗？</b></span></p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>烧伤后瘢痕性秃发的治疗有以下几种方法：</b></p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>1、完全撕脱<br />
</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 伤口完全愈合后，如病人急于解决秃发问题，可以装配假发，这就是所谓的赝复治疗。</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>2、皮瓣法或叫次切除法<br />
</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 这种方法适用于尚留有部分头发者，可以设计成条状皮瓣转移到容貌迫切需要的部位，如额前发际区两侧颞区等，待头以长出后，即可掩盖秃发部位，在秃发区不大，且周围组织较松的部位，可以分次切除瘢痕，游离周围皮下组织，直接缝合，也可完全消除秃发，但秃发面积太大就不能应用此方法。</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>3、插秧法</b><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 有时所有的有发区域无法转移皮瓣时，则可以采用插秧的方法，在有头发的区域取一窄条带毛囊的头皮，顺毛囊的方向将其切成2x3mm的小片，植于秃发区，在秃发区用利刀片切一2x2mm 的创面，并将其皮下稍加剥离，以便将皮片插入，由于秃发区的皮肤很紧，皮片须要用缝针将其缝合固定一针，否则皮片易被挤出伤口。有时插秧法与皮瓣转移可以联合应用。</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>4、皮肤扩张器法</b><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 部分秃发的病人也可以使用硅胶制的扩张囊，这种囊有各种不同大小与形状，，并有一可供注射灭菌生理盐水的阀相连。水可以注入而不致漏出，手术时将此扩张器械埋入有毛发的头皮皮下，术后在阀注入生理盐水，当扩张皮皮肤量足够时，就可以切除瘢痕，用带有毛发的头皮修复创面。</p></div></td>
  </tr>
</table>
                  </td>
                  </tr>
