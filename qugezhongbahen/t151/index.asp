...
<meta name="keywords" content="烧伤后瘢痕性睑外翻" />
<meta name="description" content="1、Z成形或V~Y成形术 一般用以矫正条索状瘢痕或部分轻度性外翻。2、皮片移植术 切成瘢痕，完全矫正睑外翻畸后所遗留的创面，如小面积的眼睑皮肤缺损可从同侧或对侧眼睑切取小皮片修复。如较大面积的缺损，则需用耳后、锁骨上或上臂内侧的皮片。应用植皮的方法治疗睑外翻，为了获得更好的效果，在植皮的同时要行睑缘粘连术。睑粘连术用于单一眼睑外翻时，比较适用，对于双睑外翻者最好行分期、单独的松解术，即先矫治上睑，后再松解下睑，这样可使创面尽量张开，植以较大或两倍大的皮片，以抵偿日后皮片的收缩。3、复合组织移植修复法 如下" />
<title>烧伤后瘢痕性睑外翻</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div class="content" id="artcontent"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: medium"><b>烧伤后瘢痕性睑外翻能治吗？</b></span></p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 瘢痕性眼睑外翻是眼睑和其周围皮肤受到破坏的结果，其处理方法是将外翻的眼睑彻底复位，应用游离皮片或转移局部皮瓣组织以弥补眼睑组织的缺损。上下眼睑在游离植皮时所用片厚度不一样，上睑需用中厚皮片修复以便于启闭活动，并易于形成上睑皱襞；下睑则用全厚皮片以保持稳定。瘢痕性眼睑外翻，治疗要及时，否则发生角膜炎，影响视力。</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>1、Z成形或V~Y成形术</b><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 一般用以矫正条索状瘢痕或部分轻度性外翻。</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>2、皮片移植术</b><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 切成瘢痕，完全矫正睑外翻畸后所遗留的创面，如小面积的眼睑皮肤缺损可从同侧或对侧眼睑切取小皮片修复。如较大面积的缺损，则需用耳后、锁骨上或上臂内侧的皮片。应用植皮的方法治疗睑外翻，为了获得更好的效果，在植皮的同时要行睑缘粘连术。睑粘连术用于单一眼睑外翻时，比较适用，对于双睑外翻者最好行分期、单独的松解术，即先矫治上睑，后再松解下睑，这样可使创面尽量张开，植以较大或两倍大的皮片，以抵偿日后皮片的收缩。</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>3、复合组织移植修复法</b><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 如下睑损伤较深、睑板也缺损时、可用取自耳甲后侧的带皮肤、软骨的复合移植片修复。</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>4、皮瓣修复法</b><br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 上颌骨骨炎所致的睑外翻若只用骨或软骨进行修复时，有的外形不佳；如用局部易位皮瓣或皮下蒂皮瓣修复效果更好。</p></div></td>
  </tr>
</table>
                  </td>
                  </tr>
