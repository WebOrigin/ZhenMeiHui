...
function color(){document.getElementById('WO_color').style.visibility='visible';}
...
document.getElementById('WO_color').style.visibility='hidden';}}
...
function hiddenDiv(){document.getElementById('WO_color').style.visibility='hidden';}
