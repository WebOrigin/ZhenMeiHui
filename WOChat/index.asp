...
<title>真美汇 - WebOrigin Chat</title>
...
<table width="1019" border="0" align="center" cellpadding="0" cellspacing="0" class="home_bg_2">
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="home_bg_nt_2">
          ...
          <tr>
            <td height="37" id="page_title"><div onmouseover="show_menu(-2);">在线咨询</div></td>
            </tr>
          <tr>
            <td valign="top">
    ...
    <tr>
      <td height="260">
        <iframe name="wochat_display" frameborder="0" class="wo_chat_if_2" src="wochat_display.asp"></iframe>
        </td>
      </tr>
    <tr>
      <td height="7"></td>
    ...
    <tr>
      <td height="35">
        <iframe name="wochat_input" frameborder="0" scrolling="no" class="wo_chat_if_2" src="wochat_input.asp?wdm=w"></iframe>
        </td>
      </tr>
</table>                      </td>
                    <td width="30"></td>
