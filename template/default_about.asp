...
<table width="1019" border="0" align="center" cellpadding="0" cellspacing="0" class="home_bg_3">
  <tr class="home_bg_2">
      ...
      <tr>
        ...
        <td><div class="five_menu_base_2">
          ...
          <div class="five_info_bar">
            ...
            <div class="five_info_cell" style="left:90px; top:-60px;" id="five_info_1"> Liposuction </div>
    ...
    <td><table width="977" border="0" cellpadding="0" cellspacing="0" class="home_bg_nt_2">
      <tr>
        <td width="788" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td valign="top"><div onmouseover="show_menu(-2);">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                <td width="14">&nbsp;</td>
                  <td class="template_b_mtext">{WebOrigin:inside/}</td>
                  <td width="140">&nbsp;</td>
                </tr>
              </table>
            </div></td>
