...
var slider = function() {
	...
	return {
		init : function() {
			...
			this.s1 = new Slider("slider", 12, 48/77, 1/3, 70);
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="home_bg_nt_2">
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="37" id="page_title"><div onmouseover="show_menu(-2);">真美汇“五心”服务</div></td>
          </tr>
          <tr>
            <td><div>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <td valign="top" height="330"><div id="center" onmouseover="show_menu(-2);">
                        <div id="slider">
                          <div class="slide">
                            ...
                            <div class="text">
                              <span class="title">安心接送</span><br>
                              所有就治患者报销市内交通费，VIP客户提前3天预约即可享受安心免费接送服务；<br/><br/><br/>
                               <span class="sub_title">①<br/>安<br/>心<br/>接<br/>送</span>
                              </div>
                            </div>
                          <div class="slide">
                            <img class="diapo" src="flow_images/02.jpg" alt="">
                            <div class="text">
                              <span class="title">贴心预约</span><br>
                              提供个性化的酒店及机票贴心预订服务，让您轻松无忧；<br/><br/><br/>
                               <span class="sub_title">②<br/>贴<br/>心<br/>预<br/>约</span>
                              </div>
                            </div>
                          <div class="slide">
                            <img class="diapo" src="flow_images/03.jpg" alt="">
                            <div class="text">
                              <span class="title">放心餐饮</span><br />
                              医护人员24小时为您提供口味齐全、卫生、放心的点餐服务；<br/><br/><br/>
                               <span class="sub_title">③<br/>放<br/>心<br/>餐<br/>饮</span>
                              </div>
                            </div>
                          <div class="slide">
                            <img class="diapo" src="flow_images/04.jpg" alt="">
                            <div class="text">
                              <span class="title">真心辅导</span><br>
                              手术前，心理专家真心辅导。手术后，专家真心为您定时检查。<br/>出院后，定期回访伴您美丽终身；<br/><br/>
                               <span class="sub_title">④<br/>真<br/>心<br/>辅<br/>导</span>
                              </div>
                            </div>
                          <div class="slide">
                            <img class="diapo" src="flow_images/05.jpg" alt="">
                            <div class="text">
                              <span class="title">全新洗衣</span><br>
                              提供全新服装干洗、湿洗、熨烫、修补服务，48h为您完成。<br/><br/><br/>
                               <span class="sub_title">⑤<br/>全<br/>新<br/>洗<br/>衣</span>
                              </div>
                            </div>
                          </div>
                        </div></td>
