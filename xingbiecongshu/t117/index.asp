...
<meta name="keywords" content="心理及性激素治疗" />
<meta name="description" content="心理及性激素治疗" />
<title>心理及性激素治疗</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div class="content" id="artcontent"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: medium"><b>心理及性激素治疗</b></span></p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 目前心理调节、精神干预、行为修饰等心理治疗往往不能奏效。关于激素治疗，一般认为男性患者应用雌激素是有帮助的，它可产生一个暂时性的化学性阉割作用，并有镇静效果。女性患者应用雄激素，可使体毛增多、喉结突出、肌肉发达、嗓音变粗等，使其在第二性征上接近男性。</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 易性癖治疗是否成功，不仅取决于解剖学上的性别改变，更在于患者生理和心理协调统一，以术后的性别身份正常地生活、工作和学习。</p></div></td>
  </tr>
</table>
                  </td>
                  </tr>
